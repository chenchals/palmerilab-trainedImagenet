% Add dir to path
WORK_DIR = '/home/subravcr/apps/tom/imagenet-train';
DATA_DIR = '/home/subravcr/apps/tom/data';
addpath(WORK_DIR)
...
net.meta.trainOpts.batchSize = 64;% 128 works for 2-Gpu but not for 1 GPU?
% -------------------------------------------------------------------------
%                                                                     Learn
% -------------------------------------------------------------------------
